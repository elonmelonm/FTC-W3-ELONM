  ...
  return (
    <div className="xl:mt-[100px] ">
      <div className="flex flex-col px-4 md:px-16 xl:px-[130px] gap-5 ">
        <div className="xl:py-[22px] xl:pl-5 xl:pr-[49px] flex flex-col xl:flex-row gap-[34px] border border-neutral-10 rounded-[20px]  ">
          <div className="flex flex-col gap-[17px] ">
            ...
            <div className="flex flex-row w-full h-12 bg-brand-gradient py-[9px] rounded-[10px] px-3 justify-between gap-[9px] ">
            ...
            <div className="flex flex-row h-8 py-1.5 px-2.5 gap-[21px] ">
              ...
              <div className="flex flex-row w-[129px] justify-between ">
                <span>
          ...
          <div className="flex flex-1 flex-col gap-[18px] ">
            ...
            <div className="flex flex-col w-[302px] h-[96px] gap-1.5">
              <div className="flex flex-col gap-0.5">
                <span className="h-5 text-neutral-40 leading-5 font-medium text-[14px] ">SKU #1000078</span>
            ...
            {/* les buttons */}
            <div className="flex flex-row w-[373px] gap-[18px]">
              ...
              <button className='flex items-center w-[217px] h-11 border-[2px] border-primary-80 rounded-[57px] pl-6 pr-7 gap-2.5 '>
                <span className="">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
