...
export function Knowledge() {
  return (
    <div className="flex flex-col min-h-[634px] px-[130px] py-[60px] gap-7 ">
        <div className="relative flex flex-row">
            <div className="flex flex-col w-[367px] h-[62px] gap-0.5 ">
                ...
                <span className="w-[367px] h-[36px] font-bold text-primary leading-[36px] tracking-[0] text-[24px]">Useful pet knowledge</span>
            </div>
        ...
        <div className="grid grid-cols-3 gap-5 ">
            <div className="w-[380px] h-[424px] bg-white p-2 ">
                <img className="w-[364px] h-[240px] rounded-[10px] " src="" alt="" />
                <div className="flex flex-col w-[364px] h-[160px] p-2 gap-2.5 ">
                    ...
                    <div className="flex flex-col w-[348px] h-[114px] gap-1.5 ">
