  ...
  return (
    <div className="flex flex-col min-h-[634px] p-4 md:px-16 xl:px-[130px] py-10 xl:py-[60px] gap-7 ">
        <div className="relative flex flex-row">
            ...
            <motion.button whileHover={{ scale: 1.1 }}  className='hidden text-primary xl:flex items-center absolute right-0 bottom-0 w-[151px] h-12 border rounded-[57px] px-7 gap-2 cursor-pointer'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 ">
            ...
            <motion.div key={index} whileHover={{ scale: 1.1 }} className="w-full min-h-[424px] custom-shadow-1 bg-white p-2 cursor-pointer ">
                <img className="w-full h-[240px] rounded-[10px] " src={knowledge.image} alt="" />
                <div className="flex flex-col w-full min-h-[160px] p-2 gap-2.5 ">
                    ...
                    <div className="flex flex-col w-full min-h-[114px] gap-1.5 ">
                        <span className="w-full min-h-[24px] text-neutral-100 font-bold leading-[24px] tracking-[0] text-[16px]">{knowledge.title}</span>
                        <span className="flex w-full min-h-[60px] text-neutral-60  leading-[20px] tracking-[0] text-[14px]">
