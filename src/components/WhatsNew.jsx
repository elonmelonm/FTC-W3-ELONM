    ...
    <div className="relative flex flex-col min-h-[200px] px-[130px] py-[60px] gap-7 ">
        <div className="relative flex flex-row">
            <div className="flex flex-col w-[367px] h-[60px] gap-0.5 ">
                ...
                <span className="w-[367px] h-[36px] font-bold text-primary leading-[36px] tracking-[0] text-[24px]">Take a look at some of our pets</span>
            </div>
        ...
        <div className="grid grid-cols-4 gap-5 ">
            <div className="w-[280px] h-[378px] bg-neutral-00 p-2 ">
                <img className="w-[264px] h-[264px] rounded-[10px] " src="" alt="" />
                <div className="w-[264px] h-[98px] pt-2 px-2 pb-5 gap-4 ">
                    <div className="flex flex-col w-[248px] h-[70px] gap-1 ">
                        <span className="w-full h-[24px] text-neutral-100 font-bold leading-[24px] tracking-[0] text-[16px]">MO231 - Pomeranian White</span>
                        <span className="flex items-center w-full h-[24px] text-neutral-60  leading-[24px] tracking-[0] text-[16px]">
