    ...
    <div className="px- md:px-16 xl:px-[130px]  ">
        <div className="relative overflow-hidden rounded-[20px] h-[640px] lg:h-[378px] bg-primary ">
            ...
            <motion.div 
                ...
                animate={{ opacity: 1 }}
                transition={{ duration: 0.8 }}
                className="flex flex-col text-center lg:text-end absolute w-[342px] lg:w-[403px] top-8 lg:top-[64px] sm:right-5 md:right-[155px] lg:right-[55px] xl:right-[85px] gap-3 lg:gap-2">
                ...
                <div className="flex flex-row mt-4 gap-2 sm:gap-5 justify-center sm:justify-end">
                    ...
                    <motion.button whileHover={{ scale: 1.1 }} className='flex items-center text-neutral-00 bg-primary w-[163px] h-12 border rounded-[57px] px-7 gap-2 hover:text-primary hover:border-primary hover:bg-transparent cursor-pointer'>
